...
#### 3. 수치로 표현하는 습관을 가지고 있음.(추상적으로 표현하는 것을 상황마다 틀리나 대부분 잘 안 씁니다.)
#### 4. 배움을 즐김.(배우는 과정이 재밌으면 즐기는 편임.)
#### 5. 친화력(공과 사를 구분하지 않고, 거의 반말로 하는 편임.)
#### 6. 응용력(해당 문제에 대해서 다양한 방법을 제시하는 편임.)
...
**대학교 4학년 현재,** 정보처리기사 필기, 실기를 다 합격되고 받기까지 졸업작품을 위해 주식 시장 공부를 하며, AI 기반 자동 매매 프로그램와 비교할 수 있도록 개인마다 배운 방법으로 수익을 내서 누가 더 나은지 데이터를 수집하며 진행하고 있습니다. 그리고 친아버지가 큰 사고를 치셔서 화난 형을 위해 빨리 취직을 해서 조금이나마 보좌해주려고 제가 일할 수 있는 기업들을 찾으면서 준비하고 있습니다.   

현재는 들어가고 싶은 것은 당연히 **~~네카라쿠배당토~~**    
는 농담이고 제가 원하는 환경은 **자유롭게 개발**할 수 있고, **유저들과 소통**을 즐기거나 **수학적으로 접근하는 개발**을 밀어주는 기업이라면 거기서 일해보고 싶습니다.   
이왕이면 팀원들과 분쟁이 잘 안 나고, 서로 적당히 선을 지킬 줄 알고, 열정있는 사람들이면 좋겠습니다._~~지금까지 진행한 팀 프로젝트에서 잠수 타는 분들, 참여 안하는 분들, 간단한 기초조차 못하는 분들이 일을 떠넘기려 행위들을 많이 봐와서 "에휴 그런갑다." 합니다.~~_
